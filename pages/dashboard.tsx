      ...
      <div className="bg-white">
        <div className="flex-col flex">
          <div className="w-full border-b-2 border-gray-200">
            <div className="bg-white h-20 justify-between items-center mx-auto px-4 flex">
              <div>
                <img src="https://static.vecteezy.com/system/resources/previews/000/615/674/non_2x/letter-b-bubble-logo-template-or-icon-vector-illustration.jpg"
                  className="block  h-20 w-auto sm:h-20" alt="" />
              </div>
                    ...
                    <span className="justify-center items-center flex">
                      <span className="items-center justify-center flex">
                        <svg className="w-5 h-5 text-gray-400" fill="none"  stroke="currentColor"
                          strokeWidth="2"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0
                      11-14 0 7 7 0 0114 0z"/></svg>
                      </span>
                    </span>
                  </span>
                </p>
                <input placeholder="Type to search" type="search" className="border border-gray-300 focus:ring-cyan-700
              focus:border-cyan-700 sm:text-sm w-full rounded-lg pt-2 pb-2 pl-10 px-3 py-2"/>
              </div>
              <div className="md:space-x-6 justify-end items-center ml-auto flex space-x-3">
                ...
                hover:text-gray-900 focus:outline-none hover:bg-gray-100">
                      ...
                      <span className="justify-center items-center flex">
                        <span className="items-center justify-center flex">
                          <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" 
                            stroke="currentColor" strokeWidth="2"><path stroke-linecap="round" stroke-linejoin="round"
                  ...
                  <p className="px-1.5 py-0.5 font-semibold text-xs items-center bg-cyan-700 text-white rounded-full inline-flex
                ...
                <div className="justify-center items-center flex relative">
                  ...
                  <p className="font-semibold text-sm">Bhagyashree chauhan</p>
                </div>
              </div>
            </div>
          </div>
